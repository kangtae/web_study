    ...
    e.prototype = {
        ...
        place: function() {
            ...
            if (this.component) {
                ...
                } else if (this.pickerPosition == "bottom-start" || this.pickerPosition == "top-start") {  
                  h = this.component.parent().offset().left
                }
            } else {
        ...
        fill: function() {
            ...
            var E = new Date(this.viewDate),
                ...
                D = new Date();
            if (this.language == "ko") {
              this.picker.find(".datetimepicker-days thead th:eq(1)").text(q +"년 " + d[this.language].months[F]);
            } else { 
            ...
            if (this.formatViewType == "time") {
                ...
                // this.picker.find(".datetimepicker-hours thead th:eq(1)").text((d[this.language].meridiem[0]).toUpperCase()+", "+(d[this.language].meridiem[1]).toUpperCase());
                this.picker.find(".datetimepicker-hours thead").html("<th colspan='7' style='width:185px;height:0;'></th>")
                // this.picker.find(".datetimepicker-minutes thead th:eq(1)").text(j + " " + d[this.language].months[F] + " " + q)
                this.picker.find(".datetimepicker-minutes thead th:eq(1)").text(((z % 12 ? z % 12 : 12) < 10 ? "0" : "")+(z % 12 ? z % 12 : 12) +":00")
            }
            ...
            if (this.language == "ko") {
              var k = this.picker.find(".datetimepicker-months").find("th:eq(1)").text(q+"년").end().find("span").removeClass("active");
            } else {
            ...
            if (this.language == "ko") { 
              var G = this.picker.find(".datetimepicker-years").find("th:eq(1)").text(q + "년 - " + (q + 9)+"년").end().find("td");
            } else {
